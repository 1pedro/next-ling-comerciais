...
function Page() {
    var _a = react_1.default.useState([]), products = _a[0], setProducts = _a[1];
        ...
        function fetchProducts() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, products_1.getAvailableProducts)()];
                        case 1:
                            data = (_a.sent()).result;
                            setProducts(data);
                            return [2 /*return*/];
                ...
                <div>
                    ...
                    <div className='bg-red-600'>
                        ...
                        <div className='grid grid-cols-3 gap-5 '>
                            <Catalog_1.default products={products}/>
                        </div>
                    </div>
                </div>
                <Services_1.default />
